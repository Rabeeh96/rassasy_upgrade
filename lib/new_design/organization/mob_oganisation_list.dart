                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return ExpansionTile(
                              onExpansionChanged: (v) async {
                                ...
                                if (expire) {
                                  dialogBox(context,
                                      "${companyController.companyListData[index].companyName} Expired! Please Contact us(+91 95775 00400 | +966 53 313 4959 | +971 52295 6284)to continue");
                                } else {
                                        ...
                                        return GestureDetector(
                                            onTap: () async {
                                              ...
                                              await Navigator.pushReplacement(
                                                  context, MaterialPageRoute(builder: (BuildContext context) => const EnterPinNumber()));
                                            },
                                            child: InkWell(
                                              child: Padding(
                                                ...
                                                child: ListTile(
                                                  ...
                                                  title: Padding(
                                                    ...
                                                    child: Text(
                                                      companyController.companyListData[index].branches![i].nickName ??
                                                  ...
                                                  trailing: Text(
                                                      companyController.companyListData[index].branches![i].branchID == 1 ? "Head Office" : "Branch",
                                                      textAlign: TextAlign.right,
                                                      style: customisedStyle(
                                                          context,
                                                          companyController.companyListData[index].branches![i].branchID == 1
                                                              ? Color(0xffF25F29)
                                                              : Color(0xff28AAF4),
                                                          FontWeight.normal,
                                                          14.0)),
