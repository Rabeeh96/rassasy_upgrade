...
class _OrganizationDetailState extends State<OrganizationList> {
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () {
      companyController.getCompanyListDetails();
    ...
    return Scaffold(
      body: Container(
        ...
        child: Stack(
          ...
          children: [
            Container(
              width: isTablet ? screenWidth /2.6 : screenWidth /1,
              height:  isTablet ? screenHeight /1.3 : screenHeight /1,
                    ...
                    /// create section commented
                            ...
                            Row(
                              children: [
                                GestureDetector(
                                  ...
                                  onTap: () {
                                    companyController.companyList.clear();
                                    companyController.getCompanyListDetails();
                                  },
                                ),
                                IconButton(
                      ...
                      Padding(
                          ...
                          child: Container(
                              ...
                              height:  isTablet ? screenHeight /2 : screenHeight /1.25,
                              child: Obx(() {
                                        ...
                                        child: Card(
                                          child: ListTile(
                                            leading: CircleAvatar(
                                              ...
                                              backgroundImage: companyController.companyList[index]
                                                  .image ==
                                                  ''
                                                  ? NetworkImage(
                                                  'https://www.gravatar.com/avatar/$index?s=46&d=identicon&r=PG&f=1')
                                                  : NetworkImage(
                                                  companyController.companyList[index].image),
                                            ),
                                            trailing: Container(
