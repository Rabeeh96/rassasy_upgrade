              ...
              ValueListenableBuilder(
                  ...
                  builder: (BuildContext ctx,DateTime fromDateNewValue, _) {
                    ...
                    return GestureDetector(
                      ...
                      onTap: (){
                        showDatePickerFunction(context,invoiceController.fromDateNotifier);
                        print("invoiceController.fromDateNotifier ${invoiceController.fromDateNotifier}");
                        print("c ${fromDateNewValue}");
                        print("c ${invoiceController.apiDateFormat.format(fromDateNewValue)}");
                        invoiceController.viewList(fromDate: invoiceController.apiDateFormat.format(fromDateNewValue), toDate: invoiceController.apiDateFormat.format(invoiceController.toDateNotifier.value));
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                  invoiceController.dateFormat.format(toDateNewValue),
                                  style: customisedStyle(context, Colors.black, FontWeight.w700, 12.0)
                              ),
                ...
                child: Obx(() => invoiceController.isLoading.value
                    ...
                    child: ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Slidable(
                          key: ValueKey( invoiceController.invoiceList[index]),
                              ...
                              children: [
                                ...
                                Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        "${invoiceController.currency} ${roundStringWith(invoiceController
        .invoiceList[index].netTotal)}"
                                        ,
                                        style: customisedStyle(
                                            context,
                                            Color(0xff000000),
