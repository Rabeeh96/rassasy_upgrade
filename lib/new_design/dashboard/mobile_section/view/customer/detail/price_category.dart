...
class SelectPriceCategoryMobile extends StatefulWidget {
  @override
  State<SelectPriceCategoryMobile> createState() => _SelectTaxState();
}

class _SelectTaxState extends State<SelectPriceCategoryMobile> {
  ...
  void initState() {
    ...
    super.initState();
    customerController.getCategoryList();
        ...
        children: [
          ...
          Expanded(
              child: Obx(() => customerController.isCategoryLoad.value
                  ...
                  : customerController.categoryList.isEmpty
                  ? Center(
                  child: Text(
                    "No Category",
                  ...
                  : ListView.separated(
                itemCount:  customerController.categoryList.length,
                itemBuilder: (BuildContext context, int index) {
                  return GestureDetector(
                    onTap: (){
                      Navigator.pop(context, [customerController.categoryList[index].catId ,customerController.categoryList[index].priceCategoryName]);
                    ...
                    child: InkWell(
                      ...
                      child: Padding(
                        ...
                        child:    Text(
                          customerController
                              .categoryList[index].priceCategoryName
                          ,
