...
class POSMobilePage extends StatelessWidget {
  ...
  POSMobilePage({super.key}) : landingPageController = Get.put(POSController());
            ...
            items: [
              BottomNavigationBarItem(
                ...
                icon: Container(
                  ...
                  child: SvgPicture.asset("assets/svg/dine.svg",color:  landingPageController.tabIndex.value==0? Color(0xffF25F29):Colors.grey,),
              ...
              BottomNavigationBarItem(
                icon:Container(
                  ...
                  margin: EdgeInsets.only(bottom: 7),
                  child: SvgPicture.asset("assets/svg/takeout_dining.svg",color:  landingPageController.tabIndex.value==1? Color(0xffF25F29):Colors.grey),
                ),
              ...
              BottomNavigationBarItem(
                icon: Container(
                  ...
                  margin: EdgeInsets.only(bottom: 7),
                  child: SvgPicture.asset("assets/svg/online_img.svg",color:  landingPageController.tabIndex.value==2? Color(0xffF25F29):Colors.grey),
              ...
              BottomNavigationBarItem(
                icon: Container(
                  ...
                  margin: EdgeInsets.only(bottom: 7),
                  child: SvgPicture.asset("assets/svg/car_inmgs.svg",color:  landingPageController.tabIndex.value==3? Color(0xffF25F29):Colors.grey),
  ...
  Widget build(BuildContext context) {
     POSController landingPageController =
