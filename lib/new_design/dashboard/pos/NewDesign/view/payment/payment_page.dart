                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            ...
                            Text(
                              'cash'.tr,
                              style: customisedStyle(context, Color(0xff000000), FontWeight.w500, 18.0),
                            ),
                          ]),
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: TextField(
                                    ...
                                    //   FocusScope.of(context).requestFocus();
                                    // },
                                    onTap: () => paymentController.cashReceivedController.selection =
                                        TextSelection(baseOffset: 0, extentOffset: paymentController.cashReceivedController.value.text.length),
                              ...
                              Container(
                                ...
                                child: TextButton(
                                  ...
                                  onPressed: () {
                                    ...
                                    paymentController.cashReceivedController.text = roundStringWith(paymentController.grandTotalAmount.value.toString());
                                    paymentController.calculationOnPayment();
                                  },
                                  child: Padding(
                                    ...
                                    child: Text(
                                      'Full'.tr,
                                      style: customisedStyle(context, const Color(0xffffffff), FontWeight.normal, 17.0),
                                    ),
                                  ),
                                ),
                              ),
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: TextField(
                                    ...
                                    onTap: () => paymentController.bankReceivedController.selection =
                                        TextSelection(baseOffset: 0, extentOffset: paymentController.bankReceivedController.value.text.length),
                                    decoration: TextFieldDecoration.defaultTextField(hintTextStr: 'amount'.tr),
                                  ),
                                ),
                              ),
                              Container(
                                ...
                                child: TextButton(
                                  ...
                                  onPressed: () {
                                    ...
                                    paymentController.bankReceivedController.text = roundStringWith(paymentController.grandTotalAmount.value.toString());
                                    paymentController.calculationOnPayment();
                                  },
                                  child: Padding(
                                    padding: const EdgeInsets.only(left: 12.0, right: 12),
