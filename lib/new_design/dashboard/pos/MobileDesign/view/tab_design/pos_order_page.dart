            ...
            children: [
              Text(
                ...
                style: customisedStyle(
                    context, const Color(0xff585858), FontWeight.w500, 13.0),
              ),
              Text(
                              ...
                              return Container(
                                  decoration: BoxDecoration(
                                    ...
                                    gradient: LinearGradient(
                                      colors:
                                          orderController.selectedIndex.value ==
                                                  index
                                              ? [
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    Padding(
                      padding:
                          const EdgeInsets.only(left: 20.0, right: 10, top: 7),
                      child: Container(
                              ...
                              children: [
                                ...
                                ValueListenableBuilder<bool>(
                                  ...
                                  builder: (context, isVegValue, child) {
                                    return GestureDetector(
                                      onTap: () {
                                        orderController.isVegNotifier.value =
                        ...
                        : Expanded(
                            child: Obx(() => GridView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    var alreadyExist = orderController.checking(
                                        orderController
                                      ...
                                      child: GestureDetector(
                                        onTap: () async {
                                          ...
                                          var taxDetails = orderController
                                              .productList[index].taxDetails;

                                          if (taxDetails != "") {
                                            orderController.productTaxID.value =
                                                taxDetails["TaxID"];
                                            orderController.productTaxName
                                          ...
                                          orderController.productID.value =
                                              orderController
                                                  .productList[index].productID;
                                          orderController.isInclusive.value =
                                              orderController.productList[index]
                                                  .isInclusive;

                                          orderController.detailIdEdit.value =
                                              0;
                                          ...
                                          var newTax = orderController
                                              .productList[index].exciseData;

                                          if (newTax != "") {
                                            orderController
                                                .isExciseProduct.value = true;
                                            ...
                                            orderController
                                                    .isAmountTaxBefore.value =
                                                newTax["IsAmountTaxBefore"];
                                            orderController
                                                    .isAmountTaxAfter.value =
                                            ...
                                            orderController
                                                .exciseTaxBefore.value = "0";
                                            orderController.isAmountTaxBefore
                                                .value = false;
                                            orderController
                                                .isAmountTaxAfter.value = false;
                                            orderController
                                                .isExciseProduct.value = false;
                                            orderController
                              ...
                              children: [
                                Container(
                                  ...
                                  child: GestureDetector(
                                    onTap: () {
                                      setState(() {
                                        if (orderController.heightOfImage <=
                                            1) {
                                        } else {
                                          orderController.heightOfImage =
                                              orderController.heightOfImage -
                                                  1;
                                          orderController
                                              .heightImageSizeController.text =
                                          "${orderController.heightOfImage}";
                                        }
                                      });
                                    },
                                ...
                                Container(
                                  ...
                                  child: TextField(
                                    controller:
                                    orderController.heightImageSizeController,
                                    textAlign: TextAlign.center,
                                    inputFormatters: [
                                      FilteringTextInputFormatter.allow(
                                          RegExp(r'[0-9]')),
                            ...
                            child: Row(
                              ...
                              children: [
                                    ...
                                    onTap: () {
                                      setState(() {
                                        orderController.widthOfImage =
                                            orderController.widthOfImage +
                                                1;
                                        orderController.widthImageSizeController.text =
                                        "${orderController.widthOfImage}";
                                      });
                                    },
                                    child: InkWell(
                                ...
                                Container(
                                  ...
                                  child: TextField(
                                    controller:
                                    orderController.widthImageSizeController,
                                    textAlign: TextAlign.center,
                                    inputFormatters: [
                                      FilteringTextInputFormatter.allow(
                                          RegExp(r'[0-9]')),
                                ...
                                Container(
                                  ...
                                  child: GestureDetector(
                                      onTap: () {
                                        setState(() {
                                          if (orderController.widthOfImage <=
                                              1) {
                                          } else {
                                            orderController.widthOfImage =
                                                orderController.widthOfImage -
        ...
        Container(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
                ...
                hintStyle: customisedStyle(
                    context, const Color(0xffA5A5A5), FontWeight.normal, 12.0),
                border: InputBorder.none),
          ),
        ),
        dividerStyle(),
