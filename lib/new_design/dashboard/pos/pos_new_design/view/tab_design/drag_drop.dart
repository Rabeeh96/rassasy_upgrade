...
class _DragDropState extends State<DragDrop> {
      ...
      body: Container(
        ...
        child: Row(
          children: [
            ...
            ///
            Flexible(flex: 3, child: groupListReorderableWidget()),

            ///product list section
            Flexible(flex: 10, child: productListReorderableWidget()),
  ...
  Widget groupListReorderableWidget() {
    return Container(
      decoration: const BoxDecoration(
        border: Border(right: BorderSide(color: Color(0xffE9E9E9))),
      ),
        ...
        if (orderController.groupIsLoading.value) {
          ...
          return ReorderableListView.builder(
            ...
            onReorder: (oldIndex, newIndex) {
              ...
              print(
                  "Reordering: Old index ID = ${orderController.groupList[oldIndex].groupID}, New index ID = ${orderController.groupList[newIndex].groupID}");

              // Adjust indices if needed
              if (newIndex > oldIndex) {
                newIndex -= 1;
              }
              final item = orderController.groupList.removeAt(oldIndex);
              orderController.groupList.insert(newIndex, item);
            ...
            itemBuilder: (BuildContext context, int index) =>
              ...
              child: Card(
                  ...
                  child: GestureDetector(
                    ...
                    key: ValueKey(orderController.groupList[index].groupID),
                          ...
                          gradient: LinearGradient(
                            colors: orderController.selectedIndex.value == index
                                ? [
                                    ...
                                    const Color(0xffff4400).withOpacity(.001)
                                  ]
                  ...
                  child: Obx(() => ReorderableGridView.builder(
                        ...
                        itemBuilder: (context, index) {
                          var alreadyExist = orderController.checking(
                              orderController.productList[index].productID);
                          return Container(
                              key: ValueKey(
                                  orderController.productList[index].productID),
                                ...
                                child: InkWell(
                                  child: Padding(
                                    padding: const EdgeInsets.only(
                                        left: 5.0, right: 5, top: 8, bottom: 8),
                                    child: Row(
                                      mainAxisAlignment:
                        ...
                        onReorder: (oldIndex, newIndex) {
                          ...
                          final item =
                              orderController.productList.removeAt(oldIndex);
                          orderController.productList.insert(newIndex, item);
                          printReorderedIDs(orderController.productList);
                        },
                      )),
                ))
        ],
