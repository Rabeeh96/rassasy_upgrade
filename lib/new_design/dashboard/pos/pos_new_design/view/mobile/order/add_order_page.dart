          ...
          children: [
            ...
            Row(
              children: [
                ...
                orderController.synMethod.value?Container():
                Padding(
              ...
              children: [
                Obx(() {
                  return orderController.synMethod.value
                      ...
                      icon:   Text('Sync',style: customisedStyleBold(context, Colors.black, FontWeight.w500, 16.0),))
                      : Container();
                }),
