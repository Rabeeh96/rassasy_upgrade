...
.footer
{
  ...
  static String invoiceDesign1(width) {
  ...
  <div class="line-1"></div>
    ...
    for (var i = 0; i < tableDataDetailsPrint.length; i++) {
      ...
      printItems += """<tr>
               ...
               <td class="textRight" style="width: 17% ;  padding:0px 15px" >${tableDataDetailsPrint[i].qty}</td>
               <td class="textRight" style='font-weight: 800;  padding:0px 15px'>${tableDataDetailsPrint[i].netAmount}</td>
