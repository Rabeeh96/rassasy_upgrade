...
class ArabicThermalPrint {
  ...
  /// wifi
  static Future<String>  invoiceDesign() async{
    ...
    var companyLogoPrint = prefs.getBool('companyLogoInPrint') ?? false;
    var  taxDetailsInPrint = prefs.getBool('taxDetailsInPrint') ?? false;
    var upiQrCodePrint = prefs.getBool('QrCodeWithUpi') ?? false;
  ...
  <div class="line-1"></div>
    ...
    for (var i = 0; i < tableDataDetailsPrint.length; i++) {
      ...
      printItems += """<tr>
               ...
               <td style="width: 65%;  padding:0px 15px"><span style="font-weight: 600;font-size: 23px;">${tableDataDetailsPrint[i].productDescription}</span></td>
               <td class="textRight" style="width: 17% ;  padding:0px 15px" >${roundStringWith(tableDataDetailsPrint[i].qty)}</td>
               <td class="textRight" style='font-weight: 800;  padding:0px 15px'>${roundStringWith(tableDataDetailsPrint[i].netAmount)}</td>
    ...
    var company_logo_section = """ """;
    if(companyLogoPrint){
      company_logo_section = """<tr><td colspan="2"><img class='company-logo' src='$companyLogo'/></td></tr>""";
    }


    var company_vat_section = """ """;
    var total_tax_detail = """ """;
    if(companyLogoPrint){
      company_vat_section = """<tr>
