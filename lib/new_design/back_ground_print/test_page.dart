...
// import 'back_ground_print_wifi.dart';
// import 'demo.dart';
//  import 'suni_printer/sunmi_printer.dart';
//
//
//
...
//   }
//
//   var sunmiHelper = new SunmiPrint();
//
//   loadDefault()async{
...
//     var arabicText = "السلام عليكم ورحمة الله وبركاته";
//     var companyAddress1 = "ضريبه";
//     // var companyAddress2 = BluetoothPrintThermalDetails.address2Company;
//     var companyCountry = "Saudi arabia";
//     var companyPhone = '8714152075';
//     var companyTax = '336547896514353';
//     var companyCrNumber = '847454/56884';
//
//
//     var voucherNumber = "SO234";
//     var name = "Rabeeh";
//     var date = "2022";
//     var phone = '8714152075';
//     var grossAmount = roundStringWith("550");
//     var discount = roundStringWith("50");
//     var totalTax = roundStringWith('100');
//     var grandTotal = roundStringWith("600");
//      var token = "Token 125";
//
//
//
...
//     Uint8List arabicTextEncoded = await CharsetConverter.encode("ISO-8859-6", setString(arabicText));
//     Uint8List h6E = await CharsetConverter.encode("ISO-8859-6", setString(invoiceType));
//     Uint8List h1E = await CharsetConverter.encode("ISO-8859-6", setString(companyAddress1));
//     Uint8List h2E = await CharsetConverter.encode("ISO-8859-6", setString(companyCountry));
//     Uint8List h3E = await CharsetConverter.encode("ISO-8859-6", setString(companyTax));
//     Uint8List h4E = await CharsetConverter.encode("ISO-8859-6", setString(companyCrNumber));
//     Uint8List h5E = await CharsetConverter.encode("ISO-8859-6", setString(companyPhone));
//
//     printer.setStyles(PosStyles(codeTable: 'CP864',align: PosAlign.center));
//
//     printer.textEncoded(arabicTextEncoded,styles:PosStyles(height:PosTextSize.size2,width:PosTextSize.size1,align: PosAlign.center));
//
//
//     // printer.textEncoded(h1E,styles:PosStyles(height:PosTextSize.size1,width:PosTextSize.size1,align: PosAlign.center));
//     // printer.textEncoded(h2E,styles:PosStyles(height:PosTextSize.size1,width:PosTextSize.size1,align: PosAlign.center));
...
//     //   PosColumn(text: token, width: 8),
//     // ]);
//     //
//     // printer.row([
//     //   PosColumn(text: 'Voucher No :', width: 4, styles: PosStyles(height: PosTextSize.size1, width: PosTextSize.size1)),
//     //   PosColumn(text: voucherNumber, width: 8, styles: PosStyles(height: PosTextSize.size1, width: PosTextSize.size1)),
//     // ]);
//     // printer.row([
//     //   PosColumn(text: 'Date       :', width: 4, styles: PosStyles(height: PosTextSize.size1, width: PosTextSize.size1)),
...
//     //   PosColumn(textEncoded:customerName, width: 9, styles: PosStyles(height: PosTextSize.size1, width: PosTextSize.size1)),
//     // ]);
...
//     //   var a = i + 1;
//     //
//     //   Uint8List description = await CharsetConverter.encode("ISO-8859-6", setString("السلام عليكم"));
//     //   printer.row([
//     //     PosColumn(text: "$a", width: 1, styles: PosStyles(height: PosTextSize.size1,)),
//     //     PosColumn(text: 'Apple', width: 6, styles: PosStyles(height: PosTextSize.size1,)),
//     //     PosColumn(text: '1', width: 2, styles: PosStyles(height: PosTextSize.size1,)),
//     //     PosColumn(text: '152', width: 1, styles: PosStyles(height: PosTextSize.size1,)),
//     //     PosColumn(text:'150', width: 2, styles: PosStyles(height: PosTextSize.size1,)),
//     //   ]);
//     //
//     //   printer.row([
//     //       PosColumn(textEncoded:description, width: 7,styles: PosStyles(height: PosTextSize.size1, width: PosTextSize.size1)),
//     //       PosColumn(text: '', width: 5, styles: PosStyles(height: PosTextSize.size1,)),
//     //     ]);
//     //
//     //   printer.hr();
//     // }
...
// //
// //
// //     final ByteData data1 = await rootBundle.load('assets/logo.png');
...
// //       PosColumn(text: roundStringWith(grandTotal), width: 3, styles: PosStyles(fontType: PosFontType.fontA,bold: true)),
// //     ]);
//
//
...
//     //
//     //  final content = Demo.inv(width+"mm");
//     //
//     //  Uint8List bytesa = await WebcontentConverter.contentToImage(content: content,duration: 1);
//     //
//     //  final Image? imagea = decodeImage(bytesa);
//     //
//     // // testReceipt(printer,bytesa);
//     //
//     //   printer.imageRaster(imagea!,highDensityHorizontal: false,highDensityVertical: false);
//     // print("_____asdfghgh");
//     // // printer.image(imagea!,align:PosAlign.center,);
//     //  printer.cut();
//     // // print('8');
//   }
//
...
//     final PosPrintResult res = await printer.connect(ipController.text, port: port,);
//
//     print(res.msg);
...
//   }
//
//   void directPrintOpenDrawer(BuildContext ctx) async {
//
//
//     // TODO Don't forget to choose printer's paper size
//     const PaperSize paper = PaperSize.mm80;
...
//     print(res.msg);
//     if(res == PosPrintResult.success) {
//       await demoPrintOpenDrawer(printer);
//       printer.disconnect();
//     }
//     else{
//       dialogBox(context, "Check printer connection");
//     }
//   }
//
...
//   }
//   Future<void> demoPrintOpenDrawer(NetworkPrinter printer) async {
//
//
//
//
...
//
//
//     // printer.text('ViknCodes',
//     //     styles: PosStyles(
//     //         height: PosTextSize.size1,
//     //         bold: true,
//     //         width: PosTextSize.size1,
//     //         align: PosAlign.center));
//     // final Uint8List imageData = await _fetchImageData("https://www.api.viknbooks.com/media/company-logo/Express_40_EX_200_1_page-0001.jpg");
...
//
//         await DemoPrint(printer);
//       // await salesInvoicePrintDemo(printer);
//        }
//
//       printer.disconnect();
//     }
