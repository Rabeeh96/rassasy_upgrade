...
class AppBlocs {
  ...
  Future<void> InvoicePrintTemplate4(NetworkPrinter printer, tokenVal, paymentDetailsInPrint, headerAlignment, salesMan, OpenDrawer) async {
    ...
    if (headerAlignment) {
      ...
      if (companyName != "") {
        printer.textEncoded(companyNameEnc,
            styles: PosStyles(height: PosTextSize.size2, width: PosTextSize.size1, fontType: PosFontType.fontA, bold: true, align: PosAlign.center));
      }
      ...
      if (companyAddress1 != "") {
        printer.row([
          PosColumn(text: 'Address', width: 2, styles: PosStyles(align: PosAlign.left)),
          PosColumn(text: '', width: 1),
          PosColumn(
              textEncoded: secondAddress1Encode,
              width: 9,
              styles: PosStyles(height: PosTextSize.size1, width: PosTextSize.size1, align: PosAlign.right)),
        ]);
      ...
      if (secondAddress != "") {
        printer.row([
          PosColumn(text: 'Building ', width: 2, styles: PosStyles(align: PosAlign.left)),
      ...
      if (companyTax != "") {
        printer.row([
          PosColumn(text: 'Vat Number', width: 2, styles: PosStyles(align: PosAlign.left)),
          PosColumn(text: '', width: 1, styles: PosStyles(align: PosAlign.left)),
          PosColumn(
              textEncoded: companyTaxEnc, width: 9, styles: PosStyles(height: PosTextSize.size1, width: PosTextSize.size1, align: PosAlign.right)),
        ]);
      ...
      if (companyPhone != "") {
        printer.row([
          PosColumn(text: 'Phone', width: 2, styles: PosStyles(align: PosAlign.left)),
          PosColumn(text: '', width: 1, styles: PosStyles(align: PosAlign.left)),
          PosColumn(
              textEncoded: companyPhoneEnc, width: 9, styles: PosStyles(height: PosTextSize.size1, width: PosTextSize.size1, align: PosAlign.right)),
        ]);
      ...
      if (salesMan != "") {
        printer.row([
          PosColumn(text: 'Sales man', width: 2, styles: PosStyles(align: PosAlign.left)),
          PosColumn(text: '', width: 1, styles: PosStyles(align: PosAlign.left)),
          PosColumn(
      ...
      if (companySecondName != "") {
        printer.textEncoded(companySecondNameEncode, styles: PosStyles(height: PosTextSize.size2, width: PosTextSize.size1, align: PosAlign.center));
      }

      if (companyAddress1 != "") {
        printer.textEncoded(secondAddress1Encode, styles: PosStyles(height: PosTextSize.size2, width: PosTextSize.size1, align: PosAlign.center));
      }

      if (secondAddress != "") {
        printer.textEncoded(secondAddressEncode, styles: PosStyles(height: PosTextSize.size1, width: PosTextSize.size1, align: PosAlign.center));
      }
      ...
      if (salesMan != "") {
        printer.textEncoded(salesManDetailsEnc, styles: PosStyles(height: PosTextSize.size1, width: PosTextSize.size1, align: PosAlign.center));
      }
    ...
    printer.text('', styles: PosStyles(align: PosAlign.left));
    printer.textEncoded(invoiceTypeArabicEnc, styles: PosStyles(height: PosTextSize.size1, width: PosTextSize.size1, align: PosAlign.center));
    ...
    if (tokenVal) {
      ...
      printer.text('', styles: PosStyles(align: PosAlign.left));
      printer.text(token, styles: PosStyles(height: PosTextSize.size2, width: PosTextSize.size2, bold: true, align: PosAlign.center));
      printer.text('', styles: PosStyles(align: PosAlign.left));
      printer.textEncoded(tokenEnc, styles: PosStyles(bold: true, height: PosTextSize.size1, width: PosTextSize.size1, align: PosAlign.center));
      printer.hr();
    } else {
      printer.row([
    ...
    printer.row([
      ...
      PosColumn(
          ...
          width: 3,
          styles: PosStyles(fontType: PosFontType.fontA, height: PosTextSize.size1, width: PosTextSize.size1, align: PosAlign.right)),
    ...
    if (customerName != "") {
      printer.row([
        ...
        PosColumn(
            textEncoded: customerNameEnc, width: 6, styles: PosStyles(height: PosTextSize.size1, width: PosTextSize.size1, align: PosAlign.right)),
      ]);
    }
    if (customerPhone != "") {
      printer.row([
        ...
        PosColumn(
            textEncoded: phoneNoEncoded, width: 6, styles: PosStyles(height: PosTextSize.size1, width: PosTextSize.size1, align: PosAlign.right)),
      ]);
    }
    ...
    if (tableName != "") {
      printer.row([
        PosColumn(text: 'Table Name   ', width: 3, styles: PosStyles(height: PosTextSize.size1, width: PosTextSize.size1)),
        PosColumn(textEncoded: tableEnc, width: 3, styles: PosStyles(height: PosTextSize.size1, width: PosTextSize.size1, align: PosAlign.right)),
        PosColumn(text: tableName, width: 6, styles: PosStyles(height: PosTextSize.size1, width: PosTextSize.size1, align: PosAlign.right)),
      ]);
    }
    ...
    printer.row([
      ...
      PosColumn(text: 'Item Name', width: 5, styles: PosStyles(height: PosTextSize.size1, align: PosAlign.center)),
    ...
    printer.row([
      ...
      PosColumn(textEncoded: productNameEnc, width: 5, styles: PosStyles(height: PosTextSize.size1, align: PosAlign.center)),
    ...
    for (var i = 0; i < tableDataDetailsPrint.length; i++) {
      ...
      printer.row([
        ...
        PosColumn(
            text: roundStringWith(tableDataDetailsPrint[i].unitPrice), width: 2, styles: PosStyles(height: PosTextSize.size1, align: PosAlign.right)),
        PosColumn(
            text: roundStringWith(tableDataDetailsPrint[i].netAmount), width: 3, styles: PosStyles(height: PosTextSize.size1, align: PosAlign.right)),
      ]);
    ...
    printer.row([
      ...
      PosColumn(
          ...
          width: 4,
          styles: PosStyles(fontType: PosFontType.fontA, height: PosTextSize.size1, width: PosTextSize.size1, align: PosAlign.right)),
      PosColumn(text: roundStringWith(grossAmount), width: 4, styles: PosStyles(align: PosAlign.right)),
    ]);
    ...
    if (showExcise) {
      ...
      printer.row([
        PosColumn(text: 'Total Excise Tax', width: 4, styles: PosStyles(fontType: PosFontType.fontB)),
        PosColumn(
            textEncoded: exciseTax,
            width: 4,
            styles: PosStyles(fontType: PosFontType.fontA, height: PosTextSize.size1, width: PosTextSize.size1, align: PosAlign.right)),
        PosColumn(text: roundStringWith(exciseAmountTotal), width: 4, styles: PosStyles(align: PosAlign.right)),
      ]);
      printer.row([
        PosColumn(text: 'Total VAT', width: 4, styles: PosStyles(fontType: PosFontType.fontB)),
        PosColumn(
            textEncoded: vatTax,
            width: 4,
            styles: PosStyles(fontType: PosFontType.fontA, height: PosTextSize.size1, width: PosTextSize.size1, align: PosAlign.right)),
        PosColumn(text: roundStringWith(vatAmountTotal), width: 4, styles: PosStyles(align: PosAlign.right)),
      ]);
    ...
    printer.row([
      ...
      PosColumn(
          ...
          width: 4,
          styles: PosStyles(fontType: PosFontType.fontA, height: PosTextSize.size1, width: PosTextSize.size1, align: PosAlign.right)),
      PosColumn(text: roundStringWith(totalTax), width: 4, styles: PosStyles(align: PosAlign.right)),
    ]);
    ...
    printer.row([
      ...
      PosColumn(
          ...
          styles: PosStyles(fontType: PosFontType.fontA, height: PosTextSize.size1, width: PosTextSize.size1, align: PosAlign.right)),
      PosColumn(text: roundStringWith(discount), width: 4, styles: PosStyles(align: PosAlign.right)),
    ]);
    // printer.setStyles(PosStyles.defaults());
    ...
    printer.row([
      ...
      PosColumn(
          textEncoded: gt,
          width: 3,
          styles: PosStyles(fontType: PosFontType.fontA, height: PosTextSize.size1, width: PosTextSize.size1, align: PosAlign.right, bold: true)),
      PosColumn(
      ...
      if (paymentDetailsInPrint) {
        printer.row([
          ...
          PosColumn(
              textEncoded: cr,
              width: 5,
              styles: PosStyles(fontType: PosFontType.fontA, height: PosTextSize.size1, width: PosTextSize.size1, align: PosAlign.left)),
  ...
  Future<void> InvoicePrintTemplateDirectText({
    ...
    printer.row([
      PosColumn(text: '', width: 3, styles: PosStyles(fontType: PosFontType.fontB)),
      PosColumn(text: '', width: 3, styles: PosStyles(height: PosTextSize.size1, width: PosTextSize.size1, align: PosAlign.center)),
      PosColumn(text: '', width: 6, styles: PosStyles(align: PosAlign.center)),
    ]);
    Uint8List companyNameEnc = await CharsetConverter.encode("ISO-8859-6", setString(companyName));
    Uint8List cityEncode = await CharsetConverter.encode("ISO-8859-6", setString(city));
    Uint8List descriptionC = await CharsetConverter.encode("ISO-8859-6", setString(description));
    ...
    if (tokenVal) {
      printer.hr();
      printer.text('Token No ', styles: PosStyles(height: PosTextSize.size1, width: PosTextSize.size1, bold: true, align: PosAlign.center));
      printer.text(tokenNumber, styles: PosStyles(height: PosTextSize.size3, width: PosTextSize.size3, bold: true, align: PosAlign.center));
      ...
      printer.row([
        PosColumn(text: 'Token No ', width: 3, styles: PosStyles(fontType: PosFontType.fontB)),
        PosColumn(textEncoded: tokenEnc, width: 3, styles: PosStyles(height: PosTextSize.size1, width: PosTextSize.size1, align: PosAlign.right)),
        PosColumn(text: tokenNumber, width: 6, styles: PosStyles(align: PosAlign.right)),
      ]);
    }
  ...
  Future<void> kotPrint(NetworkPrinter printer, id, items,bool isCancelNote,isUpdate) async {
    print('kot print function called');
    ...
    printer.text('', styles: PosStyles(align: PosAlign.left));
     ...
     printer.textEncoded(typeEng, styles: PosStyles(height: PosTextSize.size3, width: PosTextSize.size5, align: PosAlign.center, fontType: PosFontType.fontB, bold: true));
   // printer.text('', styles: PosStyles(align: PosAlign.left));
     printer.setStyles(PosStyles(codeTable: 'CP864', align: PosAlign.left));
     printer.textEncoded(typeArabic, styles: PosStyles(height: PosTextSize.size2, width: PosTextSize.size1, align: PosAlign.center, fontType: PosFontType.fontA, bold: true));
     printer.text('', styles: PosStyles(align: PosAlign.left));

    if(isCancelNote){
      printer.text(cancelNoteData, styles: PosStyles(height: PosTextSize.size2, width: PosTextSize.size1, align: PosAlign.center, fontType: PosFontType.fontB, bold: true));
      printer.setStyles(PosStyles(codeTable: 'CP864', align: PosAlign.left));
      printer.textEncoded(cancelNoteEnc, styles: PosStyles(height: PosTextSize.size1, width: PosTextSize.size1, align: PosAlign.center, fontType: PosFontType.fontA, bold: true));
    }

    if(isUpdate){
      printer.text(updateNote, styles: PosStyles(height: PosTextSize.size2, width: PosTextSize.size1, align: PosAlign.center, fontType: PosFontType.fontB, bold: true));
      printer.setStyles(PosStyles(codeTable: 'CP864', align: PosAlign.left));
      printer.textEncoded(updateNoteEnc, styles: PosStyles(height: PosTextSize.size1, width: PosTextSize.size1, align: PosAlign.center, fontType: PosFontType.fontA, bold: true));
    }
    ...
    printer.text('Token No', styles: PosStyles(height: PosTextSize.size1, width: PosTextSize.size1, bold: true, align: PosAlign.center));
    printer.text('', styles: PosStyles(align: PosAlign.left));
    printer.text(tokenNumber, styles: PosStyles(height: PosTextSize.size2, width: PosTextSize.size2, bold: true, align: PosAlign.center));
    printer.text('', styles: PosStyles(align: PosAlign.left));
    printer.textEncoded(tokenEnc, styles: PosStyles(bold: true, height: PosTextSize.size1, width: PosTextSize.size1, align: PosAlign.center));
    printer.hr();

    printer.row([
      PosColumn(text: 'Kitchen name :', width: 4, styles: PosStyles(height: PosTextSize.size1, width: PosTextSize.size1)),
      PosColumn(text: kitchenName, width: 8, styles: PosStyles(height: PosTextSize.size1, width: PosTextSize.size1)),
    ]);

    printer.row([
      PosColumn(text: 'Order type       :', width: 4, styles: PosStyles(height: PosTextSize.size1, width: PosTextSize.size1)),
      PosColumn(text: orderType, width: 8, styles: PosStyles(height: PosTextSize.size1, width: PosTextSize.size1)),
    ]);

    if (orderType == "Dining") {
      printer.row([
        PosColumn(text: 'Table Name       :', width: 4, styles: PosStyles(height: PosTextSize.size1, width: PosTextSize.size1)),
        PosColumn(text: tableName, width: 8, styles: PosStyles(height: PosTextSize.size1, width: PosTextSize.size1)),
      ]);
    }
    ...
    printer.row([
      ...
      PosColumn(text: 'Qty', width: 2, styles: PosStyles(height: PosTextSize.size1, align: PosAlign.right)),
    ]);
    printer.hr();
    ...
    for (var i = 0; i < dataPrint.length; i++) {
      ...
      printer.row([
        ...
        PosColumn(textEncoded: productName, width: 8, styles: PosStyles(height: PosTextSize.size1, width: PosTextSize.size1)),
        PosColumn(text: dataPrint[i].qty, width: 2, styles: PosStyles(height: PosTextSize.size1, align: PosAlign.right)),
      ]);

      if (productDescription != "") {
        printer.textEncoded(productDescriptionEnc, styles: PosStyles(height: PosTextSize.size1, width: PosTextSize.size1, align: PosAlign.center));
      }

      if (dataPrint[i].flavour != "") {
        printer.textEncoded(flavour, styles: PosStyles(height: PosTextSize.size1, width: PosTextSize.size1, align: PosAlign.center));
      }
      printer.hr();
    }
    printer.feed(1);
    printer.row([
      PosColumn(text: 'Total quantity', width: 3, styles: PosStyles(height: PosTextSize.size2, width: PosTextSize.size1,fontType: PosFontType.fontB, bold: true)),
      PosColumn(text: '', width: 7),
      PosColumn(text: roundStringWith(totalQty), width: 2, styles: (PosStyles(height: PosTextSize.size2, width: PosTextSize.size1,fontType: PosFontType.fontB, bold: true,align: PosAlign.right))),
    ]);
    printer.cut();
    printer.disconnect();
  }
/// arabic kot image print method
  ...
  Future<void> testPrint(NetworkPrinter printer) async {
    printer.setStyles(PosStyles.defaults());
    printer.setStyles(PosStyles(codeTable: 'CP864', align: PosAlign.center));
    printer.text('Test kot', styles: PosStyles(align: PosAlign.left));
    printer.emptyLines(1);
    printer.setStyles(PosStyles.defaults());
    printer.setStyles(PosStyles(codeTable: 'CP864'));
    printer.hr();
